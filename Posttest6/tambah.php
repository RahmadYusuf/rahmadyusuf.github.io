...
if (isset($_POST['tambah'])) { 
  ...
  if (!in_array(end($fileExtension), $validExtension)) { // Mengecek apakah ekstensi file yang diupload sesuai dengan yang diperbolehkan
    echo "
      <script>
    ...
    if (move_uploaded_file($tmp_name, 'images/' .$newFileName)) { // Memindahkan file yang diupload ke folder images
